...
export const FaqConfig: FAQ_Config[]= [
  {
    id: '1',
    question: "What type of service we provide ?",
    description:
  ...
  {
    id: '2',
    question: "What documents are required from customers to buy or sell a car with us?",
    description:
  ...
  {
    id: '3',
    question: "What are the eligibility criteria for car loan or finance approval?",
    description:
  ...
  {
    id: '4',
    question: "What are the terms for car rental/security deposit?",
    description:
  ...
  {
    id: '5',
    question: "Can customers reserve a car by paying a token amount, and is it refundable?",
    description:
  ...
  {
    id: '6',
    question: "Can I speak directly with a sales or service advisor for guidance?",
    description:
