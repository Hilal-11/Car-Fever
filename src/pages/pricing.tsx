...
export default function DocsPage() {
  ...
  return (
    ...
    <section className="flex flex-col items-center justify-center">
          <div className="pt-10 lg:pt-28 text-center px-4">
            <h1 className="Inter-bold text-3xl lg:text-7xl heading-lg2">Flexible, Transparent, and Growth-Focused Pricing Plans Designed for Startups</h1>
