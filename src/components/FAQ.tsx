  ...
  return (
    <div className=''>
        <div className='mx-auto space-y-6'>
            ...
            <p className='text-center text-md Inter-medium px-10 lg:w-1/2 mx-auto'>We are here to help you with any questions you may have. If you dont find what you need, please contact us at Find Some quick answers to the most common questions.</p>
        </div>
