  ...
  return (
    <div className='container text-center mx-auto py-20'>
        <div className='space-y-2'>
            ...
            <h1 className='lg:text-7xl text-4xl inter-bold'>Simple Price For All</h1>
            <p className='inter-medium text-lg px-10 py-2'>Choose a plan that fits your goals and scale as you grow</p>
        </div>
        <div className='container mx-auto w-full  grid lg:grid-cols-3 grid-cols-1 justify-evenly items-end gap-6 lg:px-6 px-3 py-5 lg:py-10'>
                ...
                </div>
                {
                    pricingConfig[0].features.map((pricingData , index) => (
                        <div className='' key={index}>
                            <li className='list-none flex gap-3 items-center text-[15px] inter-medium'><span className='text-slate-600'><FaCheckCircle /></span>{pricingData}</li>
                        </div>
                    ))
                }
