...
function HeroImageComponent() {
  ...
  return (
    ...
    <motion.div className='w-[90%] mx-auto h-full shadow-[0px_0px_0px_1px_rgba(0,0,0,0.06),0px_1px_1px_-0.5px_rgba(0,0,0,0.06),0px_3px_3px_-1.5px_rgba(0,0,0,0.06),_0px_6px_6px_-3px_rgba(0,0,0,0.06),0px_12px_12px_-6px_rgba(0,0,0,0.06),0px_24px_24px_-12px_rgba(0,0,0,0.06)] p-2 lg:p-2 rounded-xl bg-neutral-200 lg:mask-b-from-10 to-20'
        style={{
            rotateX: 24,
            translateZ: "0px",
            y: 6
    ...
    >   
        <div>
            <motion.img
            className='rounded-xl w-[100%] object-cover dark:mask-b-from-10 to-20 ' src={HeaderImage} alt="Error" />
        </div>
    </motion.div>
